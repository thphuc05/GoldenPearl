...
public class TrangChu extends JFrame {
    ...
    private Map<String, JPanel> cachedPanels = new HashMap<>();
    ...
    private void initUI() {
        setTitle("Hệ thống quản lý nhà hàng GOLDEN PEARL");
        setSize(1400, 900);
        ...
        // 2. Content Area (Sử dụng CardLayout)
        cardLayout = new CardLayout();
        contentArea = new JPanel(cardLayout);
        contentArea.setBackground(MAIN_BLUE);

        // CHỈ add duy nhất màn hình chào mừng lúc khởi động
