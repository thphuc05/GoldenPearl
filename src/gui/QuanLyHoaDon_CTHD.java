...
public class QLDB_GoiMon extends JDialog {
    ...
    public QLDB_GoiMon(java.awt.Window parent, HoaDon hd, java.util.List<ChiTietHoaDon> dsCT, boolean isDetail) {
        ...
        if (isDetail) {
            ...
            btnConfirm.addActionListener(e -> {
                JOptionPane.showMessageDialog(QLDB_GoiMon.this,
